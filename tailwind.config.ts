...
const config: Config = {
    ...
    theme: {
        ...
        fontSize: {
            ...
            title5: ['min(4.2vw, 1.6rem)', { letterSpacing: "0rem", lineHeight: "1.8rem", fontWeight: "400" }],
            title4: ['min(4.8vw, 1.6rem)', { letterSpacing: "0rem", lineHeight: "1.8rem", fontWeight: "400" }],
            ...
            title1: ['min(10.5vw, 5rem)', { letterSpacing: "0rem", lineHeight: "4rem", fontWeight: "400" }],
