...
export default function PrivacyPolicy() {
    return (<div className=" flex flex-col relative">
        <div className="p-8 max-w-4xl mx-auto">
            <h1 className="text-title3 font-bold text-center mb-8">プライバシーポリシー</h1>
            ...
            {/* 第1条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第1条（個人情報）</h2>
                <p>
            ...
            {/* 第2条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第2条（個人情報を収集・利用する目的）</h2>
            ...
            {/* 第3条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第3条（利用目的の変更）</h2>
                <p>
            ...
            {/* 第4条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第4条（個人情報の適正な取得）</h2>
                <p>サロン運営者は、適正に個人情報を取得し、偽りその他不正の手段により取得しません。</p>
            </section>

            {/* 第5条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第5条（個人情報の安全管理）</h2>
                <p>
            ...
            {/* 第6条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第6条（個人情報の第三者提供）</h2>
                <p>
            ...
            {/* 第7条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第7条（個人情報の開示）</h2>
                <p>
            ...
            {/* 第8条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第8条（個人情報の訂正および削除）</h2>
                <p>
            ...
            {/* 第9条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第9条（個人情報の利用停止等）</h2>
                <p>
            ...
            {/* 第10条 */}
            <section className="mb-6">
                <h2 className="text-title4 font-bold mb-4">第10条（継続的改善）</h2>
                <p>
            ...
            {/* 第11条 */}
            <section>
                <h2 className="text-title4 font-bold mb-4">第11条（お問い合わせ窓口）</h2>
                <p>
