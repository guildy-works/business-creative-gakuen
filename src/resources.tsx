...
export const resources = {
    ...
    faq: [
        {
            q: "どんな人が入ってますか",
            a: "フリーランス、SNS運用者、エンジニア、デザイナー、マーケター、映像クリエイター、LINE構築者、AI関連、イラストレーター、カメラマン、ライター、広告運用者、アフィリエイターなど幅広い業種の人がいます ただしイベントは中四国がメインとなるのでご了承ください"
        },
        {
            q: "中四国以外の人も入れますか",
            a: <>
                このコミュニティは“中四国びいき”です中四国に縁のある人や、<br />
                空気感が好きな人たちが集まっているので、それに耐えれることができら大丈夫です
            </>
        },
        {
            q: "クレジットの引き落とし日は",
            a: <>
                入会した日が会費の引き落とし日となります（体験期間中の場合は、体験キャンペーン終了日が引き落とし日）また、<br />
                体験期間中に解約した場合は料金が発生することはありません
            </>
        },
        {
            q: "プランの変更はできますか",
